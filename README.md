...
# Project Structure
TV Time Recreation/
 ├── TV_Time_RecreationApp.swift        // App entry point
 ├── Views/                             // App screens (Home, Watchlist, etc.)
 ├── Components/                        // Reusable SwiftUI components
 ├── Models/                            // Data models
 ├── Resources/                         // Images, colors, asset catalogs
 └── TV_Time_Recreation_Widget/         // WidgetKit extension
